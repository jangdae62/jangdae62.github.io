...
- 동영상
  [![](./youtube_img/.png)](https://www.youtube.com/watch?v=keyFDxLxFXY)
...
### 1. 요구사항 (6주)
#### 1. 게임화면
- 쿼터뷰의 형태로 방의 모습을 비춰주고 캐릭터가 돌아다닌다.
...
- 우측 상단에는 X버튼이 있으며 누르면 다시 게임화면으로 돌아간다.
...
- 주식 시장과 동일하게 3개의 암호화폐가 상장 되어있고 거래 가능시간또한 가능하다.
- 암호화폐 시장은 하루 가격 변동이 최대 +-200%이다.
